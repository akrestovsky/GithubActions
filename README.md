[![Run App AnastasiyanaKrestovsky](https://github.com/akrestovsky/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/akrestovsky/GithubActions/actions/workflows/run-app.yaml)
